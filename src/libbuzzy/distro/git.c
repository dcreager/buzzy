...
cs = 0;
	goto _out;
tr2:
#line 57 "libbuzzy/distro/git.c.rl"
	{
            start = p;
	...
	goto st9;
tr20:
#line 68 "libbuzzy/distro/git.c.rl"
	{
            cork_buffer_append(&buf, start, p - start);
        }
#line 72 "libbuzzy/distro/git.c.rl"
	{
...
st9:
	if ( ++p == pe )
		goto _test_eof9;
case 9:
#line 124 "libbuzzy/distro/git.c"
	switch( (*p) ) {
		case 45: goto tr18;
		case 46: goto tr19;
	}
...
#line 79 "libbuzzy/distro/git.c.rl"
	{
...
#line 86 "libbuzzy/distro/git.c.rl"
	{
...
st2:
	if ( ++p == pe )
		goto _test_eof2;
case 2:
#line 175 "libbuzzy/distro/git.c"
	switch( (*p) ) {
		case 45: goto st3;
		case 103: goto tr6;
		case 112: goto tr7;
...
#line 57 "libbuzzy/distro/git.c.rl"
	...
	goto st10;
tr14:
#line 63 "libbuzzy/distro/git.c.rl"
	{
            start = p;
...
st10:
	if ( ++p == pe )
		goto _test_eof10;
case 10:
#line 224 "libbuzzy/distro/git.c"
	switch( (*p) ) {
		case 45: goto tr21;
		case 46: goto tr22;
	}
...
st4:
	if ( ++p == pe )
		goto _test_eof4;
case 4:
#line 275 "libbuzzy/distro/git.c"
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr11;
	goto st0;
tr11:
...
st12:
	if ( ++p == pe )
		goto _test_eof12;
case 12:
#line 349 "libbuzzy/distro/git.c"
	switch( (*p) ) {
		case 45: goto tr21;
		case 46: goto tr22;
		case 112: goto st13;
...
st15:
	if ( ++p == pe )
		goto _test_eof15;
case 15:
#line 416 "libbuzzy/distro/git.c"
	switch( (*p) ) {
		case 45: goto tr21;
		case 46: goto tr22;
		case 112: goto st13;
...
st17:
	if ( ++p == pe )
		goto _test_eof17;
case 17:
#line 478 "libbuzzy/distro/git.c"
	switch( (*p) ) {
		case 45: goto tr21;
		case 46: goto tr22;
	}
...
st18:
	if ( ++p == pe )
		goto _test_eof18;
case 18:
#line 511 "libbuzzy/distro/git.c"
	switch( (*p) ) {
		case 45: goto tr32;
		case 46: goto tr33;
	}
...
st19:
	if ( ++p == pe )
		goto _test_eof19;
case 19:
#line 531 "libbuzzy/distro/git.c"
	switch( (*p) ) {
		case 45: goto tr32;
		case 46: goto tr33;
		case 112: goto st20;
...
st24:
	if ( ++p == pe )
		goto _test_eof24;
case 24:
#line 639 "libbuzzy/distro/git.c"
	switch( (*p) ) {
		case 45: goto tr32;
		case 46: goto tr33;
		case 112: goto st20;
...
st25:
	if ( ++p == pe )
		goto _test_eof25;
case 25:
#line 672 "libbuzzy/distro/git.c"
	switch( (*p) ) {
		case 45: goto st2;
		case 46: goto st4;
	}
...
st26:
	if ( ++p == pe )
		goto _test_eof26;
case 26:
#line 698 "libbuzzy/distro/git.c"
	switch( (*p) ) {
		case 45: goto tr32;
		case 46: goto tr33;
		case 112: goto st20;
...
st27:
	if ( ++p == pe )
		goto _test_eof27;
case 27:
#line 728 "libbuzzy/distro/git.c"
	switch( (*p) ) {
		case 45: goto tr32;
		case 46: goto tr33;
		case 111: goto st28;
...
st30:
	if ( ++p == pe )
		goto _test_eof30;
case 30:
#line 810 "libbuzzy/distro/git.c"
	switch( (*p) ) {
		case 45: goto tr32;
		case 46: goto tr33;
	}
...
#line 86 "libbuzzy/distro/git.c.rl"
	...
	break;
#line 938 "libbuzzy/distro/git.c"
	}
	}
...
#line 142 "libbuzzy/distro/git.c.rl"
    ...
    if (CORK_UNLIKELY(cs < 
#line 952 "libbuzzy/distro/git.c"
9
#line 147 "libbuzzy/distro/git.c.rl"
)) {
